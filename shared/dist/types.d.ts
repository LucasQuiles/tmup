...
export type EventType = 'task_created' | 'task_claimed' | 'task_completed' | 'task_failed' | 'task_cancelled' | 'task_unblocked' | 'dependency_traversal_truncated' | 'task_updated' | 'agent_registered' | 'agent_shutdown' | 'agent_heartbeat_stale' | 'dispatch' | 'harvest' | 'session_init' | 'session_pause' | 'session_resume' | 'session_teardown';

...
_raw_codex_reasoning_summary=$(_cfg_read_yaml "$CFG_CONFIG_DIR/policy.yaml" '.codex.reasoning_summary // "concise"' "concise")
...
CFG_CODEX_REASONING_SUMMARY=$(_cfg_validate_enum "CFG_CODEX_REASONING_SUMMARY" "$_raw_codex_reasoning_summary" "concise" "auto" "concise" "detailed" "none")
